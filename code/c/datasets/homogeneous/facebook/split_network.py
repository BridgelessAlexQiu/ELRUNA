...
#      Original Network      #
# -------------------------- #
G_full = nx.read_edgelist("facebook_full.edges", nodetype = int)
...
nx.write_edgelist(g1, "facebook_g1.edges", data=False)
nx.write_edgelist(g2, "facebook_g2.edges", data=False)