...
#             Remove comma           #
# ---------------------------------- #
in_file_obj = open("fission_csv.edges", 'r')
out_file_obj = open("fission_raw.edges", 'w')
...
#           Real Networks           #
# --------------------------------- #
g1 = nx.read_edgelist("fission_raw.edges")
...
# ---------------------------------------------------- #
gt_file_name = "fission_gt_mapping.txt" 
...
for p in perturbation_probability:
    ...
    #        Edgelist File       #
    # -------------------------- #
    g2_file_name = "fission_" + str(p) + '_g2.edges'
