...
out_file_obj = open("google.edges", 'w')
...
#           Real Networks           #
# --------------------------------- #
g1 = nx.read_edgelist("google.edges")
...
# ---------------------------------------------------- #
gt_file_name = "google_gt_mapping.txt"
...
for p in perturbation_probability:
    ...
    #        Edgelist File       #
    # -------------------------- #
    g2_file_name = "google_" + str(p) + '_g2.edges'
