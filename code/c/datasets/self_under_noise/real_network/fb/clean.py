...
#            Remove weights           #
#------------------------------------ #
in_file_obj = open("fb_raw.edges", 'r')
out_file_obj = open("fb.edges", 'w')
...
# ---------------------------------------------------- #
gt_file_name = "fb_gt_mapping.txt"
...
for p in perturbation_probability:
    ...
    #        Edgelist File       #
    # -------------------------- #
    g2_file_name = "fb_" + str(p) + '_g2.edges'
