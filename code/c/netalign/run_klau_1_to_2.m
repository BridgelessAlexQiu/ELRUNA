...
L_file_location = "L/self_under_noise/random_network";

output_file_location = "output/klau/self_under_noise/random_network";
...
for i = 1 : length(network_name)
    ...
    for j = 1 : length(noise)
        ...
        x = netalignmr(S,w,0,1,li,lj); % works: netalign_lagrange, netalignmr
