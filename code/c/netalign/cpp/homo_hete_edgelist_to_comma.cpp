...
int main(int argc, char* argv[])
{
    ...
    for(int i = 0; i < homo_network_name.size(); ++i)
    {
        ...
        string l_file_name = "../L/homogeneous/" + network_label + "/" + network_label + ".txt";
        ...
        int threshold = (int) log2(g1_size) * 5;
    ...
    for(int i = 0; i < hete_network_name.size(); ++i)
    {
        ...
        string l_file_name = "../L/heterogeneous/" + network_label + "/" + network_label + ".txt";
